- dashboard: monthly_threat_monitoring_report
  title: Monthly Threat Monitoring Report
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: zTxUEVdrxmFa9xWLL9BBjh
  elements:
  - title: Alerts Handled
    ...
    filters:
      vw_dashboard_cases.case_creation_time_date: 7 days
    ...
    listen:
      ...
      Case Creation Time Month: vw_dashboard_cases.case_creation_time_month
    row: 0
    col: 0
    width: 12
    height: 8
  - name: Top 10 Alerts by Technology
    title: Top 10 Alerts by Technology
    explore: vw_dashboard_cases
    type: looker_donut_multiples
    fields: [vw_dashboard_alerts.alerts_count, vw_dashboard_alerts.product]
    pivots: [vw_dashboard_alerts.product]
    filters:
      vw_dashboard_cases.case_creation_time_date: 30 days
    sorts: [vw_dashboard_alerts.product]
    limit: 10
    column_limit: 50
    ...
    width: 12
    height: 8
  - name: Variation of Combined Alerts in Recent Months
    title: Variation of Combined Alerts in Recent Months
    explore: vw_dashboard_cases
    type: looker_line
    fields: [vw_dashboard_alerts.alerts_count, vw_dashboard_cases.case_creation_time_month]
  ...
  - name: Alerts by Severity
    ...
    explore: vw_dashboard_cases
    type: looker_donut_multiples
    fields: [vw_dashboard_cases.case_priority_str, vw_dashboard_alerts.alerts_count]
    pivots: [vw_dashboard_cases.case_priority_str]
    fill_fields: [vw_dashboard_cases.case_priority_str]
    sorts: [vw_dashboard_cases.case_priority_str]
    show_value_labels: true
    font_size: 12
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    width: 12
    height: 8
  - name: Variation of Alerts by Technology in Recent Months
    title: Variation of Alerts by Technology in Recent Months
    explore: vw_dashboard_cases
    type: looker_line
    fields: [vw_dashboard_alerts.alerts_count, vw_dashboard_alerts.product, vw_dashboard_cases.case_creation_time_month]
    pivots: [vw_dashboard_alerts.product]
    fill_fields: [vw_dashboard_cases.case_creation_time_month]
    filters: {}
    ...
    width: 24
    height: 8
  - name: Top 10 Technologies by False Positive Rate Column
    title: Top 10 Technologies by False Positive Rate Column
    explore: vw_dashboard_cases
    type: looker_column
    fields: [vw_dashboard_cases.false_positive_cases_percentage, vw_dashboard_alerts.product]
    pivots: [vw_dashboard_alerts.product]
    filters:
      vw_dashboard_cases.case_creation_time_date: 14 days

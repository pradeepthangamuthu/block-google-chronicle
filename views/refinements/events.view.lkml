...
view: +events__security_result__action {
  dimension: action_enum_name {
    type:  string
    sql:  ${events__security_result__action__enum.enum_name} ;;
  }
}
...
view: +events__security_result{
  dimension: about__platform_enum_name {
    type:  string
    sql:  ${events__security_result__about__platform__enum.enum_name} ;;
  }
...
view: +events__extensions__vulns__vulnerabilities {
  dimension: severity_enum_name {
    type:  string
    sql:  ${events__extensions__vulns__vulnerabilities__severity__enum.enum_name} ;;
  }
}

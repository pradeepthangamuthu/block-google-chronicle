...
{%condition%}${events.target__asset__network_domain} {%endcondition%} or 
{%condition%}${events__about.asset__network_domain} {%endcondition%}
;;
  } # domain
...
;;
  ...
  filter: file_path_grouped_field_filter {
    ...
    sql:  {%condition%} ${events.target__file__full_path} {%endcondition%} or 
...
view: events__about__ip_geo_artifact {
  dimension: location {
    hidden: yes
  }  # dimension location
...
view: events__intermediary__asset__attribute__roles {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "intermediary"
...
view: events__intermediary__user__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "intermediary"
...
view: events__metadata__base_labels__ingestion_kv_labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "metadata"
...
view: events__metadata__enrichment_labels__ingestion_kv_labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "metadata"
...
view: events__metadata__enrichment_labels__log_types {
  dimension: events__metadata__enrichment_labels__log_types {
    type: string
    sql: ${TABLE} ;;
    group_label: "metadata"
...
view: events__metadata__enrichment_labels__namespaces {
  dimension: events__metadata__enrichment_labels__namespaces {
    type: string
    sql: ${TABLE} ;;
    group_label: "metadata"
...
view: events__network__smtp__rcpt_to {
  dimension: events__network__smtp__rcpt_to {
    type: string
    sql: ${TABLE} ;;
    group_label: "network"
...
view: events__network__smtp__server_response {
  dimension: events__network__smtp__server_response {
    type: string
    sql: ${TABLE} ;;
    group_label: "network"
...
view: events__observer__group__attribute__permissions {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "observer"
...
view: events__observer__group__attribute__roles {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "observer"
...
view: events__observer__nat_ip {
  dimension: events__observer__nat_ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "observer"
...
view: events__observer__user__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "observer"
...
view: events__principal__asset__vulnerabilities__about__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "principal"
...
view: events__principal__network__dns__additional {
  dimension: data {
    type: string
    sql: ${TABLE}.data ;;
    group_label: "principal"
...
view: events__principal__network__dns__questions {
  dimension: class {
    type: number
    sql: ${TABLE}.class ;;
    group_label: "principal"
...
view: events__principal__process__parent_process__file__names {
  dimension: events__principal__process__parent_process__file__names {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__security_result__about__asset__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
...
view: events__security_result__about__group__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "security_result"
...
view: events__security_result__about__process__file__names {
  dimension: events__security_result__about__process__file__names {
    type: string
    sql: ${TABLE} ;;
    group_label: "security_result"
...
view: events__security_result__about__user__attribute__permissions {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "security_result"
...
view: events__security_result__associations {
  dimension: id {
    type: string
    sql: ${TABLE}.id ;;
    group_label: "security_result"
...
view: events__src__file__pe_file__imports {
  dimension: functions {
    hidden: yes
  }  # dimension functions
...
view: events__src__file__pe_file__resources_language_count_str {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "src"
...
view: events__src__file__pe_file__section {
  dimension: entropy {
    type: number
    sql: ${TABLE}.entropy ;;
    group_label: "src"
...
view: events__src__file__signature_info__sigcheck__x509 {
  dimension: algorithm {
    type: string
    sql: ${TABLE}.algorithm ;;
    group_label: "src"
...
view: events__target__process__file__tags {
  dimension: events__target__process__file__tags {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
explore: events {
  ...
  join: events__intermediary__asset__attribute__roles {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__intermediary.asset}.attribute.roles) as events__intermediary__asset__attribute__roles ;;
    view_label: "UDM"
  }  # join events__intermediary__asset__attribute__roles
  ...
  join: events__intermediary__user__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__intermediary.user}.attribute.labels) as events__intermediary__user__attribute__labels ;;
    view_label: "UDM"
  }  # join events__intermediary__user__attribute__labels
  ...
  join: events__metadata__base_labels__ingestion_kv_labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.metadata}.base_labels.ingestion_kv_labels) as events__metadata__base_labels__ingestion_kv_labels ;;
    view_label: "UDM"
  }  # join events__metadata__base_labels__ingestion_kv_labels
  ...
  join: events__metadata__enrichment_labels__ingestion_kv_labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.metadata}.enrichment_labels.ingestion_kv_labels) as events__metadata__enrichment_labels__ingestion_kv_labels ;;
    view_label: "UDM"
  }  # join events__metadata__enrichment_labels__ingestion_kv_labels

  join: events__metadata__enrichment_labels__log_types {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.metadata}.enrichment_labels.log_types) as events__metadata__enrichment_labels__log_types ;;
    view_label: "UDM"
  }  # join events__metadata__enrichment_labels__log_types

  join: events__metadata__enrichment_labels__namespaces {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.metadata}.enrichment_labels.namespaces) as events__metadata__enrichment_labels__namespaces ;;
    view_label: "UDM"
  }  # join events__metadata__enrichment_labels__namespaces
  ...
  join: events__network__smtp__rcpt_to {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.network}.smtp.rcpt_to) as events__network__smtp__rcpt_to ;;
    view_label: "UDM"
  }  # join events__network__smtp__rcpt_to

  join: events__network__smtp__server_response {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.network}.smtp.server_response) as events__network__smtp__server_response ;;
    view_label: "UDM"
  }  # join events__network__smtp__server_response
  ...
  join: events__observer__group__attribute__permissions {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.observer}.group.attribute.permissions) as events__observer__group__attribute__permissions ;;
    view_label: "UDM"
  }  # join events__observer__group__attribute__permissions

  join: events__observer__group__attribute__roles {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.observer}.group.attribute.roles) as events__observer__group__attribute__roles ;;
    view_label: "UDM"
  }  # join events__observer__group__attribute__roles
  ...
  join: events__observer__nat_ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.observer}.nat_ip) as events__observer__nat_ip ;;
    view_label: "UDM"
  }  # join events__observer__nat_ip
  ...
  join: events__observer__user__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.observer}.user.attribute.labels) as events__observer__user__attribute__labels ;;
    view_label: "UDM"
  }  # join events__observer__user__attribute__labels
  ...
  join: events__principal__asset__vulnerabilities__about__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__principal__asset__vulnerabilities.about}.labels) as events__principal__asset__vulnerabilities__about__labels ;;
    view_label: "UDM"
  }  # join events__principal__asset__vulnerabilities__about__labels
  ...
  join: events__principal__network__dns__additional {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.network.dns.additional) as events__principal__network__dns__additional ;;
    view_label: "UDM"
  }  # join events__principal__network__dns__additional

  join: events__principal__network__dns__questions {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.network.dns.questions) as events__principal__network__dns__questions ;;
    view_label: "UDM"
  }  # join events__principal__network__dns__questions
  ...
  join: events__principal__process__parent_process__file__names {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.process.parent_process.file.names) as events__principal__process__parent_process__file__names ;;
    view_label: "UDM"
  }  # join events__principal__process__parent_process__file__names
  ...
  join: events__security_result__about__asset__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__security_result.about}.asset.attribute.labels) as events__security_result__about__asset__attribute__labels ;;
    view_label: "UDM"
  }  # join events__security_result__about__asset__attribute__labels
  ...
  join: events__security_result__about__group__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__security_result.about}.group.attribute.labels) as events__security_result__about__group__attribute__labels ;;
    view_label: "UDM"
  }  # join events__security_result__about__group__attribute__labels
  ...
  join: events__security_result__about__process__file__names {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__security_result.about}.process.file.names) as events__security_result__about__process__file__names ;;
    view_label: "UDM"
  }  # join events__security_result__about__process__file__names
  ...
  join: events__security_result__about__user__attribute__permissions {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__security_result.about}.user.attribute.permissions) as events__security_result__about__user__attribute__permissions ;;
    view_label: "UDM"
  }  # join events__security_result__about__user__attribute__permissions
  ...
  join: events__src__file__pe_file__imports {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.file.pe_file.imports) as events__src__file__pe_file__imports ;;
    view_label: "UDM"
  }  # join events__src__file__pe_file__imports
  ...
  join: events__src__file__pe_file__resource {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.file.pe_file.resource) as events__src__file__pe_file__resource ;;
    view_label: "UDM"
  }  # join events__src__file__pe_file__resource

  join: events__src__file__pe_file__resources_language_count_str {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.file.pe_file.resources_language_count_str) as events__src__file__pe_file__resources_language_count_str ;;
    view_label: "UDM"
  }  # join events__src__file__pe_file__resources_language_count_str

  join: events__src__file__pe_file__resources_type_count_str {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.file.pe_file.resources_type_count_str) as events__src__file__pe_file__resources_type_count_str ;;
    view_label: "UDM"
  }  # join events__src__file__pe_file__resources_type_count_str

  join: events__src__file__pe_file__section {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.file.pe_file.section) as events__src__file__pe_file__section ;;
    view_label: "UDM"
  }  # join events__src__file__pe_file__section
  ...
  join: events__src__file__signature_info__sigcheck__x509 {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.file.signature_info.sigcheck.x509) as events__src__file__signature_info__sigcheck__x509 ;;
    view_label: "UDM"
  }  # join events__src__file__signature_info__sigcheck__x509
  ...
  join: events__target__process__file__tags {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.process.file.tags) as events__target__process__file__tags ;;
    view_label: "UDM"
  }  # join events__target__process__file__tags

...
### BEGIN googlex/security/malachite/dashboards/lookml/udm/events_preamble.lkml
...
view: events {
  ...
  filter: ip_grouped_field_filter {
    ...
    sql:  {%condition%} ${events__principal__ip.events__principal__ip} {%endcondition%} or 
{%condition%}${events__src__ip.events__src__ip} {%endcondition%} or 
{%condition%}${events__target__ip.events__target__ip} {%endcondition%} or 
{%condition%}${events__observer__ip.events__observer__ip} {%endcondition%} or 
{%condition%}${events__intermediary__ip.events__intermediary__ip} {%endcondition%} or 
{%condition%}${events.principal__artifact__ip} {%endcondition%} or 
{%condition%}${events.src__artifact__ip} {%endcondition%} or 
{%condition%}${events.target__artifact__ip} {%endcondition%} or 
{%condition%}${events__principal__asset__ip.events__principal__asset__ip} {%endcondition%} or 
{%condition%}${events__src__asset__ip.events__src__asset__ip} {%endcondition%} or 
{%condition%}${events__target__asset__ip.events__target__asset__ip} {%endcondition%}
;;
  } # ip
  ...
  filter: domain_grouped_field_filter {
    ...
    sql:  {%condition%} ${events.network__dns_domain} {%endcondition%} or 
{%condition%}${events__network__dns__questions.name} {%endcondition%} or 
{%condition%}${events.principal__administrative_domain} {%endcondition%} or 
{%condition%}${events.target__administrative_domain} {%endcondition%} or 
{%condition%}${events__about.administrative_domain} {%endcondition%} or 
{%condition%}${events.target__hostname} {%endcondition%} or 
{%condition%}${events.target__asset__hostname} {%endcondition%} or 
{%condition%}${events.principal__asset__network_domain} {%endcondition%} or 
{%condition%}${events.target__asset__network_domain} {%endcondition%}
;;
  } # domain
  ...
  filter: hostname_grouped_field_filter {
    ...
    sql:  {%condition%} ${events.principal__hostname} {%endcondition%} or 
{%condition%}${events.src__hostname} {%endcondition%} or 
{%condition%}${events.target__hostname} {%endcondition%} or 
{%condition%}${events__intermediary.hostname} {%endcondition%} or 
{%condition%}${events.observer__hostname} {%endcondition%} or 
{%condition%}${events.principal__asset__hostname} {%endcondition%} or 
{%condition%}${events.src__asset__hostname} {%endcondition%} or 
{%condition%}${events.target__asset__hostname} {%endcondition%}
;;
  } # hostname
  ...
  filter: user_grouped_field_filter {
    ...
    sql:  {%condition%} ${events.principal__user__userid} {%endcondition%} or 
{%condition%}${events.src__user__userid} {%endcondition%} or 
{%condition%}${events.target__user__userid} {%endcondition%} or 
{%condition%}${events.observer__user__userid} {%endcondition%} or 
{%condition%}${events__about.user__userid} {%endcondition%} or 
{%condition%}${events.principal__user__windows_sid} {%endcondition%} or 
{%condition%}${events.target__user__windows_sid} {%endcondition%} or 
{%condition%}${events.principal__user__user_display_name} {%endcondition%} or 
{%condition%}${events.target__user__user_display_name} {%endcondition%}
;;
  } # user
  ...
  filter: email_grouped_field_filter {
    ...
    sql:  {%condition%} ${events__principal__user__email_addresses.events__principal__user__email_addresses} {%endcondition%} or 
{%condition%}${events__target__user__email_addresses.events__target__user__email_addresses} {%endcondition%} or 
{%condition%}${events__intermediary__user__email_addresses.events__intermediary__user__email_addresses} {%endcondition%} or 
{%condition%}${events__security_result__about__user__email_addresses.events__security_result__about__user__email_addresses} {%endcondition%} or 
{%condition%}${events.network__email__from} {%endcondition%} or 
{%condition%}${events__network__email__to.events__network__email__to} {%endcondition%}
;;
  } # email
  ...
  filter: file_path_grouped_field_filter {
    ...
    sql:  {%condition%} ${events.principal__file__full_path} {%endcondition%} or 
{%condition%}${events.target__file__full_path} {%endcondition%} or 
{%condition%}${events.principal__process__file__full_path} {%endcondition%} or 
{%condition%}${events.target__process__file__full_path} {%endcondition%}
;;
  } # file_path
  ...
  filter: hash_grouped_field_filter {
    ...
    sql:  {%condition%} ${events.principal__process__file__md5} {%endcondition%} or 
{%condition%}${events.target__process__file__md5} {%endcondition%} or 
{%condition%}${events.principal__process__file__sha1} {%endcondition%} or 
{%condition%}${events.target__process__file__sha1} {%endcondition%} or 
{%condition%}${events.principal__process__file__sha256} {%endcondition%} or 
{%condition%}${events.target__process__file__sha256} {%endcondition%} or 
{%condition%}${events.target__file__md5} {%endcondition%} or 
{%condition%}${events.target__file__sha1} {%endcondition%} or 
{%condition%}${events.target__file__sha256} {%endcondition%} or 
{%condition%}${events__about.file__md5} {%endcondition%} or 
{%condition%}${events__about.file__sha256} {%endcondition%} or 
{%condition%}${events__about.file__sha1} {%endcondition%} or 
{%condition%}${events__security_result.about__file__sha256} {%endcondition%}
;;
  } # hash
  ...
  filter: process_id_grouped_field_filter {
    ...
    sql:  {%condition%} ${events.principal__process__pid} {%endcondition%} or 
{%condition%}${events.target__process__pid} {%endcondition%} or 
{%condition%}${events.principal__process__product_specific_process_id} {%endcondition%} or 
{%condition%}${events.target__process__product_specific_process_id} {%endcondition%}
;;
  } # process_id
  ...
  filter: namespace_grouped_field_filter {
    ...
    sql:  {%condition%} ${events.principal__namespace} {%endcondition%} or 
{%condition%}${events.src__namespace} {%endcondition%} or 
{%condition%}${events.target__namespace} {%endcondition%}
;;
  } # namespace
  ...
  dimension: observer__artifact {
    hidden: yes
  }  # dimension observer__artifact

  dimension: observer__artifact__location {
    hidden: yes
  }  # dimension observer__artifact__location

  dimension: observer__artifact__location__name {
    type: string
    sql: ${TABLE}.observer.artifact.location.name ;;
    group_label: "observer"
    label: "observer.artifact.location.name"
    view_label: "UDM"
  ...
  dimension: observer__artifact__location__state {
    type: string
    sql: ${TABLE}.observer.artifact.location.state ;;
    group_label: "observer"
    label: "observer.artifact.location.state"
    view_label: "UDM"
  ...
  dimension: observer__process__file {
    hidden: yes
  }  # dimension observer__process__file
  ...
  dimension: observer__process__file__full_path {
    ...
    group_label: "observer"
    label: "observer.process.file.full_path"
    view_label: "UDM"
    description: "The full path identifying the location of the file on the system."
  }  # dimension observer__process__file__full_path
  ...
  dimension: observer__user__company_name {
    ...
    group_label: "observer"
    label: "observer.user.company_name"
    view_label: "UDM"
  ...
  dimension: principal__artifact__network__dns {
    hidden: yes
  }  # dimension principal__artifact__network__dns

  dimension: principal__artifact__network__dns__answers {
    hidden: yes
  }  # dimension principal__artifact__network__dns__answers
  ...
  dimension: principal__artifact__prevalence {
    hidden: yes
  }  # dimension principal__artifact__prevalence
  ...
  dimension: principal__artifact__prevalence__day_count {
    ...
    group_label: "principal"
    label: "principal.artifact.prevalence.day_count"
    view_label: "UDM"
  ...
  dimension: principal__asset__location__desk_name {
    ...
    group_label: "principal"
    label: "principal.asset.location.desk_name"
    view_label: "UDM"
  ...
  dimension: principal__cloud__vpc__parent {
    ...
    group_label: "principal"
    group_item_label: "principal.cloud.vpc.parent [D]"
    label: "principal.cloud.vpc.parent"
    view_label: "UDM"
    description: "The parent of the resource. For a database table, the parent is the database and for a storage object, the bucket name, etc.  Deprecated: use resource_ancestors.name. [D]: This field is deprecated and will be removed in a future release"
  }  # dimension principal__cloud__vpc__parent
  ...
  dimension: principal__cloud__vpc__resource_subtype {
    ...
    group_label: "principal"
    group_item_label: "principal.cloud.vpc.resource_subtype [D]"
    label: "principal.cloud.vpc.resource_subtype"
    view_label: "UDM"
    description: "Resource sub-type (e.g. \"BigQuery\", \"Bigtable\"). [D]: This field is deprecated and will be removed in a future release"
  }  # dimension principal__cloud__vpc__resource_subtype
  ...
  dimension: principal__cloud__vpc__type {
    ...
    group_label: "principal"
    group_item_label: "principal.cloud.vpc.type [D]"
    label: "principal.cloud.vpc.type"
    view_label: "UDM"
    description: "Deprecated: use resource_type instead. [D]: This field is deprecated and will be removed in a future release"
  }  # dimension principal__cloud__vpc__type
  ...
  dimension: principal__file__authentihash {
    ...
    group_label: "principal"
    label: "principal.file.authentihash"
    view_label: "UDM"
  ...
  dimension: principal__file__full_path {
    ...
    group_label: "principal"
    label: "principal.file.full_path"
    view_label: "UDM"
    description: "The full path identifying the location of the file on the system."
  }  # dimension principal__file__full_path
  ...
  dimension: principal__file__md5 {
    ...
    group_label: "principal"
    label: "principal.file.md5"
    view_label: "UDM"
    description: "The MD5 hash of the file."
  }  # dimension principal__file__md5

  dimension: principal__file__names {
    hidden: yes
  }  # dimension principal__file__names
  ...
  dimension: principal__registry__registry_key {
    ...
    group_label: "principal"
    label: "principal.registry.registry_key"
    view_label: "UDM"
  ...
  dimension: principal__registry__registry_value_data {
    ...
    group_label: "principal"
    label: "principal.registry.registry_value_data"
    view_label: "UDM"
  ...
  dimension: principal__registry__registry_value_name {
    ...
    group_label: "principal"
    label: "principal.registry.registry_value_name"
    view_label: "UDM"
  ...
  dimension: principal__user__office_address__desk_name {
    ...
    group_label: "principal"
    label: "principal.user.office_address.desk_name"
    view_label: "UDM"
    description: "Desk name or individual location, typically for an employee in an office. (e.g. \"IN-BLR-BCPC-11-1121D\")."
  }  # dimension principal__user__office_address__desk_name
  ...
  dimension: src__artifact__ip {
    ...
    group_label: "src"
    label: "src.artifact.ip"
    view_label: "UDM"
    description: "IP address of the artifact."
  }  # dimension src__artifact__ip

  dimension: src__artifact__network {
    hidden: yes
  }  # dimension src__artifact__network

  dimension: src__artifact__network__dns {
    hidden: yes
  }  # dimension src__artifact__network__dns

  dimension: src__artifact__network__dns__questions {
    hidden: yes
  }  # dimension src__artifact__network__dns__questions

  dimension: src__artifact__network__http {
    hidden: yes
  }  # dimension src__artifact__network__http

  dimension: src__artifact__network__http__parsed_user_agent {
    hidden: yes
  }  # dimension src__artifact__network__http__parsed_user_agent

  dimension: src__artifact__network__http__parsed_user_agent__browser {
    type: string
    sql: ${TABLE}.src.artifact.network.http.parsed_user_agent.browser ;;
    group_label: "src"
    label: "src.artifact.network.http.parsed_user_agent.browser"
    view_label: "UDM"
    description: "Product brand within the family: Firefox, Netscape, Camino etc.. Or Earth, Windows-Media-Player etc.. for non-browser user agents."
  }  # dimension src__artifact__network__http__parsed_user_agent__browser
  ...
  dimension: src__process__parent_process {
    hidden: yes
  }  # dimension src__process__parent_process

  dimension: src__process__parent_process__file {
    hidden: yes
  }  # dimension src__process__parent_process__file

  dimension: src__process__parent_process__file__full_path {
    type: string
    sql: ${TABLE}.src.process.parent_process.file.full_path ;;
    group_label: "src"
    label: "src.process.parent_process.file.full_path"
    view_label: "UDM"
    description: "The full path identifying the location of the file on the system."
  }  # dimension src__process__parent_process__file__full_path
  ...
  dimension: src__user__attribute__cloud__project__name {
    ...
    group_label: "src"
    group_item_label: "src.user.attribute.cloud.project.name [D]"
    label: "src.user.attribute.cloud.project.name"
    view_label: "UDM"
    description: "The full name of the resource. For example, Google Cloud: //cloudresourcemanager.googleapis.com/projects/wombat-123, and AWS: arn:aws:iam::123456789012:user/johndoe. [D]: This field is deprecated and will be removed in a future release"
  }  # dimension src__user__attribute__cloud__project__name
  ...
  dimension: src__user__office_address__desk_name {
    ...
    group_label: "src"
    label: "src.user.office_address.desk_name"
    view_label: "UDM"
    description: "Desk name or individual location, typically for an employee in an office. (e.g. \"IN-BLR-BCPC-11-1121D\")."
  }  # dimension src__user__office_address__desk_name
  ...
  dimension: target__artifact__network {
    hidden: yes
  }  # dimension target__artifact__network

  dimension: target__artifact__network__email {
    hidden: yes
  }  # dimension target__artifact__network__email

  dimension: target__artifact__network__email__subject {
    hidden: yes
  }  # dimension target__artifact__network__email__subject

  dimension: target__artifact__network__sent_bytes {
    type: number
    sql: ${TABLE}.target.artifact.network.sent_bytes ;;
    group_label: "target"
    label: "target.artifact.network.sent_bytes"
    view_label: "UDM"
    description: "The number of bytes sent."
  }  # dimension target__artifact__network__sent_bytes
  ...
  dimension: target__domain__prevalence {
    hidden: yes
  }  # dimension target__domain__prevalence
  ...
  dimension: target__domain__prevalence__day_count {
    ...
    group_label: "target"
    label: "target.domain.prevalence.day_count"
    view_label: "UDM"
    description: "The number of days over which rolling_max is calculated."
  }  # dimension target__domain__prevalence__day_count
  ...
  dimension: target__domain__prevalence__rolling_max {
    ...
    group_label: "target"
    label: "target.domain.prevalence.rolling_max"
    view_label: "UDM"
    description: "The maximum number of assets per day accessing the resource over the trailing day_count days."
  }  # dimension target__domain__prevalence__rolling_max
  ...
  dimension: target__process__product_specific_parent_process_id {
    ...
    group_label: "target"
    group_item_label: "target.process.product_specific_parent_process_id [D]"
    label: "target.process.product_specific_parent_process_id"
    view_label: "UDM"
    description: "A product specific id for the parent process. Please use parent_process.product_specific_process_id instead. [D]: This field is deprecated and will be removed in a future release"
  }  # dimension target__process__product_specific_parent_process_id
  ...
  dimension: target__user__office_address__desk_name {
    ...
    group_label: "target"
    label: "target.user.office_address.desk_name"
    view_label: "UDM"
    description: "Desk name or individual location, typically for an employee in an office. (e.g. \"IN-BLR-BCPC-11-1121D\")."
  }  # dimension target__user__office_address__desk_name
...
view: events__about__asset__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "about"
...
view: events__about__asset__attribute__permissions {
...
view: events__about__asset__hardware {
...
view: events__about__asset__vulnerabilities {
  dimension: severity {
    type: number
    sql: ${TABLE}.severity ;;
    group_label: "about"
    label: "about.asset.vulnerabilities.severity"
    view_label: "UDM"
  ...
  dimension: severity_enum_name {
    ...
    group_label: "about"
    label: "about.asset.vulnerabilities.severity_enum_name"
    view_label: "UDM"
    description: "The severity of the vulnerability."
  }  # dimension severity_enum_name
...
view: events__about__file__capabilities_tags {
  dimension: events__about__file__capabilities_tags {
    type: string
    sql: ${TABLE} ;;
    group_label: "about"
...
view: events__about__file__names {
  dimension: events__about__file__names {
    type: string
    sql: ${TABLE} ;;
    group_label: "about"
...
view: events__about__ip {
  dimension: events__about__ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "about"
    label: "about.ip"
...
view: events__about__ip_location {
  dimension: country_or_region {
    ...
    group_label: "about"
    group_item_label: "about.ip_location.country_or_region [D]"
    label: "about.ip_location.country_or_region"
    view_label: "UDM"
...
view: events__about__nat_ip {
  dimension: events__about__nat_ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "about"
    label: "about.nat_ip"
...
view: events__about__user__attribute__permissions {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "about"
...
view: events__about__user__attribute__roles {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "about"
...
view: events__about__user__department {
  dimension: events__about__user__department {
    type: string
    sql: ${TABLE} ;;
    group_label: "about"
...
view: events__about__user__email_addresses {
  dimension: events__about__user__email_addresses {
    type: string
    sql: ${TABLE} ;;
    group_label: "about"
...
view: events__about__user__group_identifiers {
  dimension: events__about__user__group_identifiers {
    type: string
    sql: ${TABLE} ;;
    group_label: "about"
...
view: events__about {
  ...
  dimension: artifact__prevalence__day_max {
    ...
    group_label: "about"
    label: "about.artifact.prevalence.day_max"
    view_label: "UDM"
  ...
  dimension: asset__location__name {
    ...
    group_label: "about"
    label: "about.asset.location.name"
    view_label: "UDM"
    description: "Custom location name (e.g. building or site name like \"London Office\"). For cloud environments, this is the region (e.g. \"us-west2\")."
  }  # dimension asset__location__name
  ...
  dimension: domain__billing {
    hidden: yes
  }  # dimension domain__billing

  dimension: domain__billing__title {
    type: string
    sql: ${TABLE}.domain.billing.title ;;
    group_label: "about"
    label: "about.domain.billing.title"
    view_label: "UDM"
    description: "User job title."
  }  # dimension domain__billing__title
  ...
  dimension: process__access_mask {
    ...
    group_label: "about"
    label: "about.process.access_mask"
    view_label: "UDM"
    description: "A bit mask representing the level of access."
  }  # dimension process__access_mask
  ...
  dimension: user__role_description {
    ...
    group_label: "about"
    group_item_label: "about.user.role_description [D]"
    label: "about.user.role_description"
    view_label: "UDM"
    description: "System role description for user. Deprecated: use attribute.roles. [D]: This field is deprecated and will be removed in a future release"
  }  # dimension user__role_description
  ...
  dimension: user__role_name {
    ...
    group_label: "about"
    group_item_label: "about.user.role_name [D]"
    label: "about.user.role_name"
    view_label: "UDM"
    description: "System role name for user. Deprecated: use attribute.roles. [D]: This field is deprecated and will be removed in a future release"
  }  # dimension user__role_name
  ...
  dimension: user__user_authentication_status {
    ...
    group_label: "about"
    label: "about.user.user_authentication_status"
    view_label: "UDM"
    description: "System authentication status for user."
  }  # dimension user__user_authentication_status

  dimension: user__user_authentication_status_enum_name {
    type: string
    suggestions: ["ACTIVE", "DELETED", "NO_ACTIVE_CREDENTIALS", "SUSPENDED", "UNKNOWN_AUTHENTICATION_STATUS"]
    sql: CASE ${TABLE}.user.user_authentication_status WHEN 0 THEN 'UNKNOWN_AUTHENTICATION_STATUS' WHEN 1 THEN 'ACTIVE' WHEN 2 THEN 'SUSPENDED' WHEN 3 THEN 'NO_ACTIVE_CREDENTIALS' WHEN 4 THEN 'DELETED' END ;;
    group_label: "about"
    label: "about.user.user_authentication_status_enum_name"
    view_label: "UDM"
    description: "System authentication status for user."
  }  # dimension user__user_authentication_status_enum_name
...
view: events__additional__fields__value__list_value__values__struct_value__fields {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
...
view: events__additional__fields__value__list_value__values {
...
view: events__additional__fields__value__struct_value__fields {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "additional"
...
view: events__additional__fields {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "additional"
...
view: events__extensions__auth__mechanism_enum_name {
  dimension: events__extensions__auth__mechanism_enum_name {
    type: string
...
view: events__intermediary__asset__ip {
  dimension: events__intermediary__asset__ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "intermediary"
...
view: events__intermediary__asset__software {
  dimension: version {
    type: string
    sql: ${TABLE}.version ;;
    group_label: "intermediary"
...
view: events__intermediary__ip {
  dimension: events__intermediary__ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "intermediary"
...
view: events__intermediary__nat_ip {
  dimension: events__intermediary__nat_ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "intermediary"
...
view: events__intermediary__process__file__names {
  dimension: events__intermediary__process__file__names {
    type: string
    sql: ${TABLE} ;;
    group_label: "intermediary"
...
view: events__intermediary__resource__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "intermediary"
...
view: events__intermediary__user__email_addresses {
  dimension: events__intermediary__user__email_addresses {
    type: string
    sql: ${TABLE} ;;
    group_label: "intermediary"
...
view: events__intermediary__user__group_identifiers {
  dimension: events__intermediary__user__group_identifiers {
    type: string
    sql: ${TABLE} ;;
    group_label: "intermediary"
...
view: events__metadata__base_labels__namespaces {
  dimension: events__metadata__base_labels__namespaces {
    type: string
    sql: ${TABLE} ;;
    group_label: "metadata"
...
view: events__metadata__ingestion_labels {
  ...
  dimension: source {
    ...
    sql: ${TABLE}.source ;;
    group_label: "metadata"
    label: "metadata.ingestion_labels.source"
    view_label: "UDM"
...
view: events__metadata__tags__tenant_id {
  dimension: events__metadata__tags__tenant_id {
    type: string
    sql: ${TABLE} ;;
    group_label: "metadata"
...
view: events__network__dhcp__options {
  dimension: code {
    type: number
    sql: ${TABLE}.code ;;
    group_label: "network"
...
view: events__network__dns__additional {
  dimension: class {
    type: number
    sql: ${TABLE}.class ;;
    group_label: "network"
...
view: events__network__dns__answers {
...
view: events__network__dns__authority {
  dimension: class {
    type: number
    sql: ${TABLE}.class ;;
    group_label: "network"
...
view: events__network__dns__questions {
  dimension: class {
    type: number
    sql: ${TABLE}.class ;;
    group_label: "network"
  ...
  dimension: prevalence__day_count {
    ...
    group_label: "network"
    label: "network.dns.questions.prevalence.day_count"
    view_label: "UDM"
    description: "The number of days over which rolling_max is calculated."
  }  # dimension prevalence__day_count
  ...
  dimension: prevalence__rolling_max {
    ...
    group_label: "network"
    label: "network.dns.questions.prevalence.rolling_max"
    view_label: "UDM"
    description: "The maximum number of assets per day accessing the resource over the trailing day_count days."
  }  # dimension prevalence__rolling_max
...
view: events__network__email__bcc {
  dimension: events__network__email__bcc {
    type: string
    sql: ${TABLE} ;;
    group_label: "network"
...
view: events__network__email__cc {
  dimension: events__network__email__cc {
    type: string
    sql: ${TABLE} ;;
    group_label: "network"
...
view: events__network__email__subject {
  dimension: events__network__email__subject {
    type: string
    sql: ${TABLE} ;;
    group_label: "network"
...
view: events__network__email__to {
  dimension: events__network__email__to {
    type: string
    sql: ${TABLE} ;;
    group_label: "network"
...
view: events__network__tls__client__supported_ciphers {
  dimension: events__network__tls__client__supported_ciphers {
    type: string
    sql: ${TABLE} ;;
    group_label: "network"
...
view: events__observer__asset__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "observer"
...
view: events__observer__asset__vulnerabilities {
  dimension_group: observer__asset__vulnerabilities__scan_start_time {
    type: time
    timeframes: [raw, microsecond, second, time, minute, hour, date, week, month, year]
    sql: TIMESTAMP_MICROS(IFNULL(${TABLE}.scan_start_time.seconds, 0) * 1000000 + CAST((IFNULL(${TABLE}.scan_start_time.nanos, 0) / 1000) as INT64)) ;;
    group_label: "observer"
    label: "observer.asset.vulnerabilities.scan_start_time"
    view_label: "UDM"
    description: "If the vulnerability was discovered during an asset scan, then this field should be populated with the time the scan started. This field can be left unset if the start time is not available or not applicable."
  }  # dimension observer__asset__vulnerabilities__scan_start_time

}  # view events__observer__asset__vulnerabilities

view: events__observer__ip {
  dimension: events__observer__ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "observer"
    label: "observer.ip"
...
view: events__observer__mac {
  dimension: events__observer__mac {
    type: string
    sql: ${TABLE} ;;
    group_label: "observer"
    label: "observer.mac"
...
view: events__observer__resource__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "observer"
...
view: events__observer__user__email_addresses {
  dimension: events__observer__user__email_addresses {
    type: string
    sql: ${TABLE} ;;
    group_label: "observer"
...
view: events__observer__user__group_identifiers {
  dimension: events__observer__user__group_identifiers {
    type: string
    sql: ${TABLE} ;;
    group_label: "observer"
...
view: events__principal__artifact__network__dns__answers {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "principal"
    label: "principal.artifact.network.dns.answers.name"
    view_label: "UDM"
    description: "The name of the owner of the resource record."
  }  # dimension name
...
view: events__principal__asset__attribute__roles {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "principal"
  ...
  dimension: type {
    ...
    sql: ${TABLE}.type ;;
    group_label: "principal"
    label: "principal.asset.attribute.roles.type"
    view_label: "UDM"
  ...
  dimension: type_enum_name {
    ...
    group_label: "principal"
    label: "principal.asset.attribute.roles.type_enum_name"
    view_label: "UDM"
    description: "System role type for well known roles."
  }  # dimension type_enum_name
...
view: events__principal__asset__hardware {
  dimension: cpu_model {
    type: string
    sql: ${TABLE}.cpu_model ;;
    group_label: "principal"
...
view: events__principal__asset__ip {
  dimension: events__principal__asset__ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__principal__asset__mac {
  dimension: events__principal__asset__mac {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__principal__asset__nat_ip {
  dimension: events__principal__asset__nat_ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__principal__asset__software__permissions {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "principal"
...
view: events__principal__asset__vulnerabilities {
  dimension: cve_description {
    type: string
    sql: ${TABLE}.cve_description ;;
    group_label: "principal"
...
view: events__principal__domain__tech__group_identifiers {
  dimension: events__principal__domain__tech__group_identifiers {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__principal__file__names {
  dimension: events__principal__file__names {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
    label: "principal.file.names"
    view_label: "UDM"
    description: "Names fields."
  }  # dimension events__principal__file__names
}  # view events__principal__file__names

view: events__principal__group__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "principal"
...
view: events__principal__group__attribute__roles {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "principal"
...
view: events__principal__group__email_addresses {
...
view: events__principal__investigation__comments {
  dimension: events__principal__investigation__comments {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__principal__ip_location {
  ...
  dimension: name {
    ...
    sql: ${TABLE}.name ;;
    group_label: "principal"
    group_item_label: "principal.ip_location.name [D]"
    label: "principal.ip_location.name"
    view_label: "UDM"
...
view: events__principal__nat_ip {
  dimension: events__principal__nat_ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__principal__process__command_line_history {
  dimension: events__principal__process__command_line_history {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__principal__process__file__capabilities_tags {
  dimension: events__principal__process__file__capabilities_tags {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__principal__process__file__names {
  dimension: events__principal__process__file__names {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__principal__process_ancestors {
  dimension: file {
    hidden: yes
  }  # dimension file
...
view: events__principal__resource__attribute__permissions {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "principal"
...
view: events__principal__resource__attribute__roles {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "principal"
...
view: events__principal__resource_ancestors__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "principal"
...
view: events__principal__user__attribute__roles {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "principal"
...
view: events__principal__user__department {
  dimension: events__principal__user__department {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__principal__user__group_identifiers {
  dimension: events__principal__user__group_identifiers {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__principal__user__managers__department {
  dimension: events__principal__user__managers__department {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__principal__user__managers__email_addresses {
  dimension: events__principal__user__managers__email_addresses {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__principal__user__managers__phone_numbers {
  dimension: events__principal__user__managers__phone_numbers {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__principal__user__managers {
  dimension: attribute {
    hidden: yes
  }  # dimension attribute
...
view: events__principal__user__phone_numbers {
  dimension: events__principal__user__phone_numbers {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: events__security_result__about__asset__attribute__permissions {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
...
view: events__security_result__about__asset__ip {
  dimension: events__security_result__about__asset__ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "security_result"
...
view: events__security_result__about__asset__mac {
  dimension: events__security_result__about__asset__mac {
    type: string
    sql: ${TABLE} ;;
    group_label: "security_result"
...
view: events__security_result__about__asset__software__permissions {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "security_result"
...
view: events__security_result__about__asset__software {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "security_result"
...
view: events__security_result__about__asset__vulnerabilities {
  dimension: cvss_base_score {
    type: number
    sql: ${TABLE}.cvss_base_score ;;
    group_label: "security_result"
...
view: events__security_result__about__domain__tech__attribute__permissions {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "security_result"
...
view: events__security_result__about__file__capabilities_tags {
  dimension: events__security_result__about__file__capabilities_tags {
    type: string
    sql: ${TABLE} ;;
    group_label: "security_result"
...
view: events__security_result__about__file__names {
...
view: events__security_result__about__investigation__comments {
  dimension: events__security_result__about__investigation__comments {
    type: string
    sql: ${TABLE} ;;
    group_label: "security_result"
...
view: events__security_result__about__ip {
  dimension: events__security_result__about__ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "security_result"
...
view: events__security_result__about__nat_ip {
  dimension: events__security_result__about__nat_ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "security_result"
...
view: events__security_result__about__user__email_addresses {
  dimension: events__security_result__about__user__email_addresses {
    type: string
    sql: ${TABLE} ;;
    group_label: "security_result"
...
view: events__security_result__about__user__group_identifiers {
...
view: events__security_result__about__user_management_chain {
  dimension: userid {
    type: string
    sql: ${TABLE}.userid ;;
    group_label: "security_result"
...
view: events__security_result__action {
  dimension: events__security_result__action {
    type: number
    sql: ${TABLE} ;;
    group_label: "security_result"
...
view: events__security_result__action_enum_name {
  dimension: events__security_result__action_enum_name {
    type: string
...
view: events__security_result__attack_details__tactics {
  dimension: id {
    type: string
    sql: ${TABLE}.id ;;
    group_label: "security_result"
...
view: events__security_result__attack_details__techniques {
  dimension: id {
    type: string
    sql: ${TABLE}.id ;;
    group_label: "security_result"
...
view: events__security_result__category {
  dimension: events__security_result__category {
    type: number
    sql: ${TABLE} ;;
    group_label: "security_result"
...
view: events__security_result__category_enum_name {
...
view: events__security_result__category_details {
...
view: events__security_result__outcomes {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "security_result"
...
view: events__security_result {
  ...
  dimension: about__domain__registrant {
    hidden: yes
  }  # dimension about__domain__registrant
  ...
  dimension: about__domain__registrant__role_description {
    ...
    group_label: "security_result"
    group_item_label: "security_result.about.domain.registrant.role_description [D]"
    label: "security_result.about.domain.registrant.role_description"
    view_label: "UDM"
    description: "System role description for user. Deprecated: use attribute.roles. [D]: This field is deprecated and will be removed in a future release"
  }  # dimension about__domain__registrant__role_description
  ...
  dimension: about__user__role_description {
    ...
    group_label: "security_result"
    group_item_label: "security_result.about.user.role_description [D]"
    label: "security_result.about.user.role_description"
    view_label: "UDM"
    description: "System role description for user. Deprecated: use attribute.roles. [D]: This field is deprecated and will be removed in a future release"
  }  # dimension about__user__role_description
...
view: events__src__artifact__network__dns__questions {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "src"
    label: "src.artifact.network.dns.questions.name"
    view_label: "UDM"
    description: "The domain name."
  }  # dimension name
...
view: events__src__asset__hardware {
  dimension: cpu_model {
    type: string
    sql: ${TABLE}.cpu_model ;;
    group_label: "src"
...
view: events__src__asset__ip {
  dimension: events__src__asset__ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "src"
    label: "src.asset.ip"
...
view: events__src__asset__mac {
  dimension: events__src__asset__mac {
    type: string
    sql: ${TABLE} ;;
    group_label: "src"
    label: "src.asset.mac"
...
view: events__src__asset__nat_ip {
  dimension: events__src__asset__nat_ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "src"
...
view: events__src__asset__software__permissions {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "src"
...
view: events__src__asset__software {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "src"
...
view: events__src__asset__vulnerabilities {
  dimension: cve_id {
    type: string
    sql: ${TABLE}.cve_id ;;
    group_label: "src"
...
view: events__src__file__embedded_domains {
  dimension: events__src__file__embedded_domains {
    type: string
    sql: ${TABLE} ;;
    group_label: "src"
...
view: events__src__file__embedded_ips {
  dimension: events__src__file__embedded_ips {
    type: string
    sql: ${TABLE} ;;
    group_label: "src"
...
view: events__src__file__embedded_urls {
  dimension: events__src__file__embedded_urls {
    type: string
    sql: ${TABLE} ;;
    group_label: "src"
...
view: events__src__file__names {
  dimension: events__src__file__names {
    type: string
    sql: ${TABLE} ;;
    group_label: "src"
...
view: events__src__file__signature_info__sigcheck__signers {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "src"
...
view: events__src__ip_geo_artifact {
  dimension: ip {
    type: string
    sql: ${TABLE}.ip ;;
    group_label: "src"
...
view: events__src__mac {
  dimension: events__src__mac {
    type: string
    sql: ${TABLE} ;;
    group_label: "src"
    label: "src.mac"
...
view: events__src__process_ancestors {
  dimension: file {
    hidden: yes
  }  # dimension file
  ...
  dimension: file__full_path {
    ...
    sql: ${TABLE}.file.full_path ;;
    group_label: "src"
    label: "src.process_ancestors.file.full_path"
    view_label: "UDM"
    description: "The full path identifying the location of the file on the system."
  }  # dimension file__full_path
...
view: events__src__resource__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "src"
  ...
  dimension: source {
    ...
    sql: ${TABLE}.source ;;
    group_label: "src"
    label: "src.resource.attribute.labels.source"
    view_label: "UDM"
    description: "@hide_from_doc"
  }  # dimension source
...
view: events__src__resource__attribute__permissions {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "src"
...
view: events__src__resource_ancestors__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "src"
...
view: events__src__user__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "src"
...
view: events__src__user__attribute__roles {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "src"
...
view: events__src__user__email_addresses {
  dimension: events__src__user__email_addresses {
    type: string
    sql: ${TABLE} ;;
    group_label: "src"
...
view: events__src__user__managers__attribute__roles {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "src"
...
view: events__src__user__managers__department {
  dimension: events__src__user__managers__department {
    type: string
    sql: ${TABLE} ;;
    group_label: "src"
...
view: events__src__user__managers__group_identifiers {
  dimension: events__src__user__managers__group_identifiers {
    type: string
    sql: ${TABLE} ;;
    group_label: "src"
...
view: events__src__user__managers__phone_numbers {
  dimension: events__src__user__managers__phone_numbers {
    type: string
    sql: ${TABLE} ;;
    group_label: "src"
...
view: events__src__user__managers {
  dimension: attribute {
    hidden: yes
  }  # dimension attribute
...
view: events__src__user__phone_numbers {
  dimension: events__src__user__phone_numbers {
    type: string
    sql: ${TABLE} ;;
    group_label: "src"
...
view: events__src__user__time_off {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "src"
...
view: events__target__artifact__network__email__subject {
  dimension: events__target__artifact__network__email__subject {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
    label: "target.artifact.network.email.subject"
    view_label: "UDM"
    description: "The subject line(s) of the email."
  }  # dimension events__target__artifact__network__email__subject
}  # view events__target__artifact__network__email__subject

view: events__target__asset__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "target"
...
view: events__target__asset__attribute__permissions {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "target"
...
view: events__target__asset__attribute__roles {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "target"
...
view: events__target__asset__hardware {
  dimension: cpu_model {
    type: string
    sql: ${TABLE}.cpu_model ;;
    group_label: "target"
...
view: events__target__asset__mac {
  dimension: events__target__asset__mac {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__asset__nat_ip {
  dimension: events__target__asset__nat_ip {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__asset__software__permissions {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "target"
...
view: events__target__asset__software {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "target"
...
view: events__target__asset__vulnerabilities {
  dimension: cve_id {
    type: string
    sql: ${TABLE}.cve_id ;;
    group_label: "target"
...
view: events__target__domain__name_server {
  dimension: events__target__domain__name_server {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__file__embedded_domains {
  dimension: events__target__file__embedded_domains {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__file__embedded_ips {
  dimension: events__target__file__embedded_ips {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__file__embedded_urls {
  dimension: events__target__file__embedded_urls {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__file__names {
...
view: events__target__file__pe_file__imports {
  dimension: functions {
    hidden: yes
  }  # dimension functions
...
view: events__target__file__pe_file__resources_language_count_str {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "target"
...
view: events__target__file__pe_file__resources_type_count_str {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "target"
...
view: events__target__file__pe_file__section {
  dimension: entropy {
    type: number
    sql: ${TABLE}.entropy ;;
    group_label: "target"
...
view: events__target__file__signature_info__sigcheck__signers {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "target"
...
view: events__target__file__signature_info__sigcheck__x509 {
  dimension: algorithm {
    type: string
    sql: ${TABLE}.algorithm ;;
    group_label: "target"
...
view: events__target__file__tags {
  dimension: events__target__file__tags {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__group__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "target"
...
view: events__target__group__attribute__permissions {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "target"
...
view: events__target__group__attribute__roles {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "target"
...
view: events__target__group__email_addresses {
  dimension: events__target__group__email_addresses {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__ip_geo_artifact {
  dimension: ip {
    type: string
    sql: ${TABLE}.ip ;;
    group_label: "target"
...
view: events__target__mac {
  dimension: events__target__mac {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
    label: "target.mac"
...
view: events__target__process__file__capabilities_tags {
  dimension: events__target__process__file__capabilities_tags {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__process__file__pe_file__signature_info__signer {
  dimension: events__target__process__file__pe_file__signature_info__signer {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__process__parent_process__file__capabilities_tags {
  dimension: events__target__process__parent_process__file__capabilities_tags {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__process__parent_process__file__names {
  dimension: events__target__process__parent_process__file__names {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__resource__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "target"
...
view: events__target__resource_ancestors__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "target"
...
view: events__target__resource_ancestors__attribute__permissions {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "target"
...
view: events__target__user__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "target"
...
view: events__target__user__attribute__permissions {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "target"
...
view: events__target__user__attribute__roles {
  dimension: description {
    type: string
    sql: ${TABLE}.description ;;
    group_label: "target"
...
view: events__target__user__managers__attribute__labels {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
    group_label: "target"
...
view: events__target__user__managers__attribute__roles {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "target"
...
view: events__target__user__managers__department {
  dimension: events__target__user__managers__department {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__user__managers__email_addresses {
  dimension: events__target__user__managers__email_addresses {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__user__managers__group_identifiers {
  dimension: events__target__user__managers__group_identifiers {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__user__managers__phone_numbers {
  dimension: events__target__user__managers__phone_numbers {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__user__managers {
  dimension: attribute {
    hidden: yes
  }  # dimension attribute
...
view: events__target__user__phone_numbers {
  dimension: events__target__user__phone_numbers {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
view: events__target__user_management_chain {
  dimension: user_display_name {
    type: string
    sql: ${TABLE}.user_display_name ;;
    group_label: "target"
    label: "target.user_management_chain.user_display_name"
    view_label: "UDM"
    description: "The display name of the user (e.g. \"John Locke\")."
  }  # dimension user_display_name
...
explore: events {
  ...
  join: events__about__asset__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__about.asset}.attribute.labels) as events__about__asset__attribute__labels ;;
    view_label: "UDM"
  }  # join events__about__asset__attribute__labels

  join: events__about__asset__attribute__permissions {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__about.asset}.attribute.permissions) as events__about__asset__attribute__permissions ;;
    view_label: "UDM"
  }  # join events__about__asset__attribute__permissions

  join: events__about__asset__hardware {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__about.asset}.hardware) as events__about__asset__hardware ;;
    view_label: "UDM"
  }  # join events__about__asset__hardware

  join: events__about__asset__ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__about.asset}.ip) as events__about__asset__ip ;;
    view_label: "UDM"
  }  # join events__about__asset__ip
  ...
  join: events__about__asset__vulnerabilities {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__about.asset}.vulnerabilities) as events__about__asset__vulnerabilities ;;
    view_label: "UDM"
  }  # join events__about__asset__vulnerabilities

  join: events__about__file__capabilities_tags {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__about.file}.capabilities_tags) as events__about__file__capabilities_tags ;;
    view_label: "UDM"
  }  # join events__about__file__capabilities_tags

  join: events__about__file__names {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__about.file}.names) as events__about__file__names ;;
    view_label: "UDM"
  }  # join events__about__file__names

  join: events__about__investigation__comments {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__about.investigation}.comments) as events__about__investigation__comments ;;
    view_label: "UDM"
  }  # join events__about__investigation__comments
  ...
  join: events__about__resource__attribute__permissions {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__about.resource}.attribute.permissions) as events__about__resource__attribute__permissions ;;
    view_label: "UDM"
  }  # join events__about__resource__attribute__permissions
  ...
  join: events__about__user__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__about.user}.attribute.labels) as events__about__user__attribute__labels ;;
    view_label: "UDM"
  }  # join events__about__user__attribute__labels

  join: events__about__user__attribute__permissions {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__about.user}.attribute.permissions) as events__about__user__attribute__permissions ;;
    view_label: "UDM"
  }  # join events__about__user__attribute__permissions

  join: events__about__user__attribute__roles {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__about.user}.attribute.roles) as events__about__user__attribute__roles ;;
    view_label: "UDM"
  }  # join events__about__user__attribute__roles

  join: events__about__user__department {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__about.user}.department) as events__about__user__department ;;
    view_label: "UDM"
  }  # join events__about__user__department

  join: events__about__user__email_addresses {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__about.user}.email_addresses) as events__about__user__email_addresses ;;
    view_label: "UDM"
  }  # join events__about__user__email_addresses

  join: events__about__user__group_identifiers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__about.user}.group_identifiers) as events__about__user__group_identifiers ;;
    view_label: "UDM"
  }  # join events__about__user__group_identifiers

  join: events__additional__fields {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.additional}.fields) as events__additional__fields ;;
    view_label: "UDM"
  }  # join events__additional__fields

  join: events__additional__fields__value__list_value__values {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__additional__fields.value}.list_value.values) as events__additional__fields__value__list_value__values ;;
    view_label: "UDM"
  }  # join events__additional__fields__value__list_value__values

  join: events__additional__fields__value__list_value__values__struct_value__fields {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__additional__fields__value__list_value__values.struct_value}.fields) as events__additional__fields__value__list_value__values__struct_value__fields ;;
    view_label: "UDM"
  }  # join events__additional__fields__value__list_value__values__struct_value__fields
  ...
  join: events__extensions__auth__mechanism {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.extensions}.auth.mechanism) as events__extensions__auth__mechanism ;;
    view_label: "UDM"
  }  # join events__extensions__auth__mechanism

  join: events__extensions__auth__mechanism_enum_name {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.extensions}.auth.mechanism) as events__extensions__auth__mechanism_enum_name ;;
    view_label: "UDM"
  }  # join events__extensions__auth__mechanism_enum_name

  join: events__extensions__vulns__vulnerabilities {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.extensions}.vulns.vulnerabilities) as events__extensions__vulns__vulnerabilities ;;
    view_label: "UDM"
  }  # join events__extensions__vulns__vulnerabilities

  join: events__extensions__vulns__vulnerabilities__about__asset__ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__extensions__vulns__vulnerabilities.about}.asset.ip) as events__extensions__vulns__vulnerabilities__about__asset__ip ;;
    view_label: "UDM"
  }  # join events__extensions__vulns__vulnerabilities__about__asset__ip

  join: events__extensions__vulns__vulnerabilities__about__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__extensions__vulns__vulnerabilities.about}.labels) as events__extensions__vulns__vulnerabilities__about__labels ;;
    view_label: "UDM"
  }  # join events__extensions__vulns__vulnerabilities__about__labels
  ...
  join: events__intermediary__asset__hardware {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__intermediary.asset}.hardware) as events__intermediary__asset__hardware ;;
    view_label: "UDM"
  }  # join events__intermediary__asset__hardware

  join: events__intermediary__asset__ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__intermediary.asset}.ip) as events__intermediary__asset__ip ;;
    view_label: "UDM"
  }  # join events__intermediary__asset__ip

  join: events__intermediary__asset__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__intermediary.asset}.labels) as events__intermediary__asset__labels ;;
    view_label: "UDM"
  }  # join events__intermediary__asset__labels

  join: events__intermediary__asset__mac {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__intermediary.asset}.mac) as events__intermediary__asset__mac ;;
    view_label: "UDM"
  }  # join events__intermediary__asset__mac
  ...
  join: events__intermediary__process__file__names {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__intermediary.process}.file.names) as events__intermediary__process__file__names ;;
    view_label: "UDM"
  }  # join events__intermediary__process__file__names

  join: events__intermediary__resource__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__intermediary.resource}.attribute.labels) as events__intermediary__resource__attribute__labels ;;
    view_label: "UDM"
  }  # join events__intermediary__resource__attribute__labels

  join: events__intermediary__user__email_addresses {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__intermediary.user}.email_addresses) as events__intermediary__user__email_addresses ;;
    view_label: "UDM"
  }  # join events__intermediary__user__email_addresses

  join: events__intermediary__user__group_identifiers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__intermediary.user}.group_identifiers) as events__intermediary__user__group_identifiers ;;
    view_label: "UDM"
  }  # join events__intermediary__user__group_identifiers

  join: events__metadata__base_labels__log_types {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.metadata}.base_labels.log_types) as events__metadata__base_labels__log_types ;;
    view_label: "UDM"
  }  # join events__metadata__base_labels__log_types

  join: events__metadata__base_labels__namespaces {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.metadata}.base_labels.namespaces) as events__metadata__base_labels__namespaces ;;
    view_label: "UDM"
  }  # join events__metadata__base_labels__namespaces

  join: events__metadata__ingestion_labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.metadata}.ingestion_labels) as events__metadata__ingestion_labels ;;
    view_label: "UDM"
  }  # join events__metadata__ingestion_labels

  join: events__metadata__tags__data_tap_config_name {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.metadata}.tags.data_tap_config_name) as events__metadata__tags__data_tap_config_name ;;
    view_label: "UDM"
  }  # join events__metadata__tags__data_tap_config_name

  join: events__metadata__tags__tenant_id {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.metadata}.tags.tenant_id) as events__metadata__tags__tenant_id ;;
    view_label: "UDM"
  }  # join events__metadata__tags__tenant_id

  join: events__network__dhcp__options {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.network}.dhcp.options) as events__network__dhcp__options ;;
    view_label: "UDM"
  }  # join events__network__dhcp__options

  join: events__network__dns__additional {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.network}.dns.additional) as events__network__dns__additional ;;
    view_label: "UDM"
  }  # join events__network__dns__additional
  ...
  join: events__network__dns__authority {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.network}.dns.authority) as events__network__dns__authority ;;
    view_label: "UDM"
  }  # join events__network__dns__authority

  join: events__network__dns__questions {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.network}.dns.questions) as events__network__dns__questions ;;
    view_label: "UDM"
  }  # join events__network__dns__questions

  join: events__network__email__bcc {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.network}.email.bcc) as events__network__email__bcc ;;
    view_label: "UDM"
  }  # join events__network__email__bcc

  join: events__network__email__cc {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.network}.email.cc) as events__network__email__cc ;;
    view_label: "UDM"
  }  # join events__network__email__cc

  join: events__network__email__subject {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.network}.email.subject) as events__network__email__subject ;;
    view_label: "UDM"
  }  # join events__network__email__subject

  join: events__network__email__to {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.network}.email.to) as events__network__email__to ;;
    view_label: "UDM"
  }  # join events__network__email__to

  join: events__network__http__parsed_user_agent__annotation {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.network}.http.parsed_user_agent.annotation) as events__network__http__parsed_user_agent__annotation ;;
    view_label: "UDM"
  }  # join events__network__http__parsed_user_agent__annotation

  join: events__network__tls__client__supported_ciphers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.network}.tls.client.supported_ciphers) as events__network__tls__client__supported_ciphers ;;
    view_label: "UDM"
  }  # join events__network__tls__client__supported_ciphers

  join: events__observer__asset__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.observer}.asset.attribute.labels) as events__observer__asset__attribute__labels ;;
    view_label: "UDM"
  }  # join events__observer__asset__attribute__labels

  join: events__observer__asset__ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.observer}.asset.ip) as events__observer__asset__ip ;;
    view_label: "UDM"
  }  # join events__observer__asset__ip
  ...
  join: events__observer__asset__vulnerabilities {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.observer}.asset.vulnerabilities) as events__observer__asset__vulnerabilities ;;
    view_label: "UDM"
  }  # join events__observer__asset__vulnerabilities

  join: events__observer__ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.observer}.ip) as events__observer__ip ;;
    view_label: "UDM"
  }  # join events__observer__ip

  join: events__observer__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.observer}.labels) as events__observer__labels ;;
    view_label: "UDM"
  }  # join events__observer__labels

  join: events__observer__mac {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.observer}.mac) as events__observer__mac ;;
    view_label: "UDM"
  }  # join events__observer__mac
  ...
  join: events__observer__user__email_addresses {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.observer}.user.email_addresses) as events__observer__user__email_addresses ;;
    view_label: "UDM"
  }  # join events__observer__user__email_addresses

  join: events__observer__user__group_identifiers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.observer}.user.group_identifiers) as events__observer__user__group_identifiers ;;
    view_label: "UDM"
  }  # join events__observer__user__group_identifiers
  ...
  join: events__principal__asset__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.asset.attribute.labels) as events__principal__asset__attribute__labels ;;
    view_label: "UDM"
  }  # join events__principal__asset__attribute__labels

  join: events__principal__asset__attribute__roles {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.asset.attribute.roles) as events__principal__asset__attribute__roles ;;
    view_label: "UDM"
  }  # join events__principal__asset__attribute__roles

  join: events__principal__asset__hardware {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.asset.hardware) as events__principal__asset__hardware ;;
    view_label: "UDM"
  }  # join events__principal__asset__hardware

  join: events__principal__asset__ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.asset.ip) as events__principal__asset__ip ;;
    view_label: "UDM"
  }  # join events__principal__asset__ip

  join: events__principal__asset__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.asset.labels) as events__principal__asset__labels ;;
    view_label: "UDM"
  }  # join events__principal__asset__labels

  join: events__principal__asset__mac {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.asset.mac) as events__principal__asset__mac ;;
    view_label: "UDM"
  }  # join events__principal__asset__mac

  join: events__principal__asset__nat_ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.asset.nat_ip) as events__principal__asset__nat_ip ;;
    view_label: "UDM"
  }  # join events__principal__asset__nat_ip
  ...
  join: events__principal__asset__vulnerabilities {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.asset.vulnerabilities) as events__principal__asset__vulnerabilities ;;
    view_label: "UDM"
  }  # join events__principal__asset__vulnerabilities

  join: events__principal__domain__name_server {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.domain.name_server) as events__principal__domain__name_server ;;
    view_label: "UDM"
  }  # join events__principal__domain__name_server

  join: events__principal__domain__tech__group_identifiers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.domain.tech.group_identifiers) as events__principal__domain__tech__group_identifiers ;;
    view_label: "UDM"
  }  # join events__principal__domain__tech__group_identifiers

  join: events__principal__file__names {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.file.names) as events__principal__file__names ;;
    view_label: "UDM"
  }  # join events__principal__file__names

  join: events__principal__group__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.group.attribute.labels) as events__principal__group__attribute__labels ;;
    view_label: "UDM"
  }  # join events__principal__group__attribute__labels

  join: events__principal__group__attribute__roles {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.group.attribute.roles) as events__principal__group__attribute__roles ;;
    view_label: "UDM"
  }  # join events__principal__group__attribute__roles

  join: events__principal__group__email_addresses {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.group.email_addresses) as events__principal__group__email_addresses ;;
    view_label: "UDM"
  }  # join events__principal__group__email_addresses

  join: events__principal__investigation__comments {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.investigation.comments) as events__principal__investigation__comments ;;
    view_label: "UDM"
  }  # join events__principal__investigation__comments

  join: events__principal__ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.ip) as events__principal__ip ;;
    view_label: "UDM"
  }  # join events__principal__ip

  join: events__principal__ip_geo_artifact {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.ip_geo_artifact) as events__principal__ip_geo_artifact ;;
    view_label: "UDM"
  }  # join events__principal__ip_geo_artifact

  join: events__principal__ip_location {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.ip_location) as events__principal__ip_location ;;
    view_label: "UDM"
  }  # join events__principal__ip_location

  join: events__principal__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.labels) as events__principal__labels ;;
    view_label: "UDM"
  }  # join events__principal__labels

  join: events__principal__mac {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.mac) as events__principal__mac ;;
    view_label: "UDM"
  }  # join events__principal__mac

  join: events__principal__nat_ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.nat_ip) as events__principal__nat_ip ;;
    view_label: "UDM"
  }  # join events__principal__nat_ip

  join: events__principal__process__command_line_history {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.process.command_line_history) as events__principal__process__command_line_history ;;
    view_label: "UDM"
  }  # join events__principal__process__command_line_history

  join: events__principal__process__file__capabilities_tags {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.process.file.capabilities_tags) as events__principal__process__file__capabilities_tags ;;
    view_label: "UDM"
  }  # join events__principal__process__file__capabilities_tags

  join: events__principal__process__file__names {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.process.file.names) as events__principal__process__file__names ;;
    view_label: "UDM"
  }  # join events__principal__process__file__names

  join: events__principal__process_ancestors {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.process_ancestors) as events__principal__process_ancestors ;;
    view_label: "UDM"
  }  # join events__principal__process_ancestors

  join: events__principal__resource__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.resource.attribute.labels) as events__principal__resource__attribute__labels ;;
    view_label: "UDM"
  }  # join events__principal__resource__attribute__labels

  join: events__principal__resource__attribute__permissions {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.resource.attribute.permissions) as events__principal__resource__attribute__permissions ;;
    view_label: "UDM"
  }  # join events__principal__resource__attribute__permissions
  ...
  join: events__principal__resource_ancestors {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.resource_ancestors) as events__principal__resource_ancestors ;;
    view_label: "UDM"
  }  # join events__principal__resource_ancestors

  join: events__principal__resource_ancestors__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__principal__resource_ancestors.attribute}.labels) as events__principal__resource_ancestors__attribute__labels ;;
    view_label: "UDM"
  }  # join events__principal__resource_ancestors__attribute__labels
  ...
  join: events__principal__user__attribute__permissions {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.user.attribute.permissions) as events__principal__user__attribute__permissions ;;
    view_label: "UDM"
  }  # join events__principal__user__attribute__permissions

  join: events__principal__user__attribute__roles {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.user.attribute.roles) as events__principal__user__attribute__roles ;;
    view_label: "UDM"
  }  # join events__principal__user__attribute__roles

  join: events__principal__user__department {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.user.department) as events__principal__user__department ;;
    view_label: "UDM"
  }  # join events__principal__user__department

  join: events__principal__user__email_addresses {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.user.email_addresses) as events__principal__user__email_addresses ;;
    view_label: "UDM"
  }  # join events__principal__user__email_addresses

  join: events__principal__user__group_identifiers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.user.group_identifiers) as events__principal__user__group_identifiers ;;
    view_label: "UDM"
  }  # join events__principal__user__group_identifiers

  join: events__principal__user__managers {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.user.managers) as events__principal__user__managers ;;
    view_label: "UDM"
  }  # join events__principal__user__managers

  join: events__principal__user__managers__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__principal__user__managers.attribute}.labels) as events__principal__user__managers__attribute__labels ;;
    view_label: "UDM"
  }  # join events__principal__user__managers__attribute__labels

  join: events__principal__user__managers__attribute__roles {
    relationship: one_to_many
  ...
  join: events__principal__user__managers__department {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__principal__user__managers.department}) as events__principal__user__managers__department ;;
    view_label: "UDM"
  }  # join events__principal__user__managers__department

  join: events__principal__user__managers__email_addresses {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__principal__user__managers.email_addresses}) as events__principal__user__managers__email_addresses ;;
    view_label: "UDM"
  }  # join events__principal__user__managers__email_addresses

  join: events__principal__user__managers__group_identifiers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__principal__user__managers.group_identifiers}) as events__principal__user__managers__group_identifiers ;;
    view_label: "UDM"
  }  # join events__principal__user__managers__group_identifiers

  join: events__principal__user__managers__phone_numbers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__principal__user__managers.phone_numbers}) as events__principal__user__managers__phone_numbers ;;
    view_label: "UDM"
  }  # join events__principal__user__managers__phone_numbers

  join: events__principal__user__phone_numbers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.principal}.user.phone_numbers) as events__principal__user__phone_numbers ;;
    view_label: "UDM"
  }  # join events__principal__user__phone_numbers

  join: events__principal__user__time_off {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.principal}.user.time_off) as events__principal__user__time_off ;;
    view_label: "UDM"
  }  # join events__principal__user__time_off
  ...
  join: events__security_result__about__asset__ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__security_result.about}.asset.ip) as events__security_result__about__asset__ip ;;
    view_label: "UDM"
  }  # join events__security_result__about__asset__ip

  join: events__security_result__about__asset__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__security_result.about}.asset.labels) as events__security_result__about__asset__labels ;;
    view_label: "UDM"
  }  # join events__security_result__about__asset__labels

  join: events__security_result__about__asset__mac {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__security_result.about}.asset.mac) as events__security_result__about__asset__mac ;;
    view_label: "UDM"
  }  # join events__security_result__about__asset__mac

  join: events__security_result__about__asset__software {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__security_result.about}.asset.software) as events__security_result__about__asset__software ;;
    view_label: "UDM"
  }  # join events__security_result__about__asset__software
  ...
  join: events__security_result__about__asset__vulnerabilities {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__security_result.about}.asset.vulnerabilities) as events__security_result__about__asset__vulnerabilities ;;
    view_label: "UDM"
  }  # join events__security_result__about__asset__vulnerabilities
  ...
  join: events__security_result__about__file__capabilities_tags {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__security_result.about}.file.capabilities_tags) as events__security_result__about__file__capabilities_tags ;;
    view_label: "UDM"
  }  # join events__security_result__about__file__capabilities_tags

  join: events__security_result__about__file__names {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__security_result.about}.file.names) as events__security_result__about__file__names ;;
    view_label: "UDM"
  }  # join events__security_result__about__file__names

  join: events__security_result__about__investigation__comments {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__security_result.about}.investigation.comments) as events__security_result__about__investigation__comments ;;
    view_label: "UDM"
  }  # join events__security_result__about__investigation__comments

  join: events__security_result__about__ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__security_result.about}.ip) as events__security_result__about__ip ;;
    view_label: "UDM"
  }  # join events__security_result__about__ip

  join: events__security_result__about__ip_location {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__security_result.about}.ip_location) as events__security_result__about__ip_location ;;
    view_label: "UDM"
  }  # join events__security_result__about__ip_location

  join: events__security_result__about__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__security_result.about}.labels) as events__security_result__about__labels ;;
    view_label: "UDM"
  }  # join events__security_result__about__labels

  join: events__security_result__about__mac {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__security_result.about}.mac) as events__security_result__about__mac ;;
    view_label: "UDM"
  }  # join events__security_result__about__mac

  join: events__security_result__about__nat_ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__security_result.about}.nat_ip) as events__security_result__about__nat_ip ;;
    view_label: "UDM"
  }  # join events__security_result__about__nat_ip

  join: events__security_result__about__process__command_line_history {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__security_result.about}.process.command_line_history) as events__security_result__about__process__command_line_history ;;
    view_label: "UDM"
  }  # join events__security_result__about__process__command_line_history

  join: events__security_result__about__resource__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__security_result.about}.resource.attribute.labels) as events__security_result__about__resource__attribute__labels ;;
    view_label: "UDM"
  }  # join events__security_result__about__resource__attribute__labels
  ...
  join: events__security_result__about__user__attribute__roles {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__security_result.about}.user.attribute.roles) as events__security_result__about__user__attribute__roles ;;
    view_label: "UDM"
  }  # join events__security_result__about__user__attribute__roles

  join: events__security_result__about__user__email_addresses {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__security_result.about}.user.email_addresses) as events__security_result__about__user__email_addresses ;;
    view_label: "UDM"
  }  # join events__security_result__about__user__email_addresses

  join: events__security_result__about__user__group_identifiers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__security_result.about}.user.group_identifiers) as events__security_result__about__user__group_identifiers ;;
    view_label: "UDM"
  }  # join events__security_result__about__user__group_identifiers

  join: events__security_result__about__user_management_chain {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__security_result.about}.user_management_chain) as events__security_result__about__user_management_chain ;;
    view_label: "UDM"
  }  # join events__security_result__about__user_management_chain
  ...
  join: events__security_result__action_enum_name {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__security_result.action}) as events__security_result__action_enum_name ;;
    view_label: "UDM"
  }  # join events__security_result__action_enum_name
  ...
  join: events__security_result__attack_details__techniques {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__security_result.attack_details}.techniques) as events__security_result__attack_details__techniques ;;
    view_label: "UDM"
  }  # join events__security_result__attack_details__techniques
  ...
  join: events__security_result__category_enum_name {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__security_result.category}) as events__security_result__category_enum_name ;;
    view_label: "UDM"
  }  # join events__security_result__category_enum_name
  ...
  join: events__src__artifact__network__dns__questions {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.artifact.network.dns.questions) as events__src__artifact__network__dns__questions ;;
    view_label: "UDM"
  }  # join events__src__artifact__network__dns__questions

  join: events__src__asset__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.asset.attribute.labels) as events__src__asset__attribute__labels ;;
    view_label: "UDM"
  }  # join events__src__asset__attribute__labels

  join: events__src__asset__hardware {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.asset.hardware) as events__src__asset__hardware ;;
    view_label: "UDM"
  }  # join events__src__asset__hardware

  join: events__src__asset__ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.asset.ip) as events__src__asset__ip ;;
    view_label: "UDM"
  }  # join events__src__asset__ip

  join: events__src__asset__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.asset.labels) as events__src__asset__labels ;;
    view_label: "UDM"
  }  # join events__src__asset__labels

  join: events__src__asset__mac {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.asset.mac) as events__src__asset__mac ;;
    view_label: "UDM"
  }  # join events__src__asset__mac

  join: events__src__asset__nat_ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.asset.nat_ip) as events__src__asset__nat_ip ;;
    view_label: "UDM"
  }  # join events__src__asset__nat_ip

  join: events__src__asset__software {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.asset.software) as events__src__asset__software ;;
    view_label: "UDM"
  }  # join events__src__asset__software
  ...
  join: events__src__asset__vulnerabilities {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.asset.vulnerabilities) as events__src__asset__vulnerabilities ;;
    view_label: "UDM"
  }  # join events__src__asset__vulnerabilities

  join: events__src__file__capabilities_tags {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.file.capabilities_tags) as events__src__file__capabilities_tags ;;
    view_label: "UDM"
  }  # join events__src__file__capabilities_tags

  join: events__src__file__embedded_domains {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.file.embedded_domains) as events__src__file__embedded_domains ;;
    view_label: "UDM"
  }  # join events__src__file__embedded_domains

  join: events__src__file__embedded_ips {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.file.embedded_ips) as events__src__file__embedded_ips ;;
    view_label: "UDM"
  }  # join events__src__file__embedded_ips

  join: events__src__file__embedded_urls {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.file.embedded_urls) as events__src__file__embedded_urls ;;
    view_label: "UDM"
  }  # join events__src__file__embedded_urls

  join: events__src__file__names {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.file.names) as events__src__file__names ;;
    view_label: "UDM"
  }  # join events__src__file__names

  join: events__src__file__signature_info__sigcheck__signers {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.file.signature_info.sigcheck.signers) as events__src__file__signature_info__sigcheck__signers ;;
    view_label: "UDM"
  }  # join events__src__file__signature_info__sigcheck__signers

  join: events__src__file__tags {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.file.tags) as events__src__file__tags ;;
    view_label: "UDM"
  }  # join events__src__file__tags

  join: events__src__ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.ip) as events__src__ip ;;
    view_label: "UDM"
  }  # join events__src__ip

  join: events__src__ip_geo_artifact {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.ip_geo_artifact) as events__src__ip_geo_artifact ;;
    view_label: "UDM"
  }  # join events__src__ip_geo_artifact
  ...
  join: events__src__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.labels) as events__src__labels ;;
    view_label: "UDM"
  }  # join events__src__labels

  join: events__src__mac {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.mac) as events__src__mac ;;
    view_label: "UDM"
  }  # join events__src__mac

  join: events__src__nat_ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.nat_ip) as events__src__nat_ip ;;
    view_label: "UDM"
  }  # join events__src__nat_ip

  join: events__src__process__file__names {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.process.file.names) as events__src__process__file__names ;;
    view_label: "UDM"
  }  # join events__src__process__file__names

  join: events__src__process_ancestors {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.process_ancestors) as events__src__process_ancestors ;;
    view_label: "UDM"
  }  # join events__src__process_ancestors
  ...
  join: events__src__resource__attribute__permissions {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.resource.attribute.permissions) as events__src__resource__attribute__permissions ;;
    view_label: "UDM"
  }  # join events__src__resource__attribute__permissions

  join: events__src__resource_ancestors {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.resource_ancestors) as events__src__resource_ancestors ;;
    view_label: "UDM"
  }  # join events__src__resource_ancestors

  join: events__src__resource_ancestors__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__src__resource_ancestors.attribute}.labels) as events__src__resource_ancestors__attribute__labels ;;
    view_label: "UDM"
  }  # join events__src__resource_ancestors__attribute__labels

  join: events__src__user__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.user.attribute.labels) as events__src__user__attribute__labels ;;
    view_label: "UDM"
  }  # join events__src__user__attribute__labels
  ...
  join: events__src__user__department {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.user.department) as events__src__user__department ;;
    view_label: "UDM"
  }  # join events__src__user__department

  join: events__src__user__email_addresses {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.user.email_addresses) as events__src__user__email_addresses ;;
    view_label: "UDM"
  }  # join events__src__user__email_addresses

  join: events__src__user__group_identifiers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.user.group_identifiers) as events__src__user__group_identifiers ;;
    view_label: "UDM"
  }  # join events__src__user__group_identifiers

  join: events__src__user__managers {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.user.managers) as events__src__user__managers ;;
    view_label: "UDM"
  }  # join events__src__user__managers

  join: events__src__user__managers__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__src__user__managers.attribute}.labels) as events__src__user__managers__attribute__labels ;;
    view_label: "UDM"
  }  # join events__src__user__managers__attribute__labels

  join: events__src__user__managers__attribute__roles {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__src__user__managers.attribute}.roles) as events__src__user__managers__attribute__roles ;;
    view_label: "UDM"
  }  # join events__src__user__managers__attribute__roles

  join: events__src__user__managers__department {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__src__user__managers.department}) as events__src__user__managers__department ;;
    view_label: "UDM"
  }  # join events__src__user__managers__department

  join: events__src__user__managers__email_addresses {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__src__user__managers.email_addresses}) as events__src__user__managers__email_addresses ;;
    view_label: "UDM"
  }  # join events__src__user__managers__email_addresses

  join: events__src__user__managers__group_identifiers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__src__user__managers.group_identifiers}) as events__src__user__managers__group_identifiers ;;
    view_label: "UDM"
  }  # join events__src__user__managers__group_identifiers

  join: events__src__user__managers__phone_numbers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__src__user__managers.phone_numbers}) as events__src__user__managers__phone_numbers ;;
    view_label: "UDM"
  }  # join events__src__user__managers__phone_numbers

  join: events__src__user__phone_numbers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.src}.user.phone_numbers) as events__src__user__phone_numbers ;;
    view_label: "UDM"
  }  # join events__src__user__phone_numbers

  join: events__src__user__time_off {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.src}.user.time_off) as events__src__user__time_off ;;
    view_label: "UDM"
  }  # join events__src__user__time_off

  join: events__target__artifact__network__email__subject {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.artifact.network.email.subject) as events__target__artifact__network__email__subject ;;
    view_label: "UDM"
  }  # join events__target__artifact__network__email__subject
  ...
  join: events__target__asset__attribute__permissions {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.asset.attribute.permissions) as events__target__asset__attribute__permissions ;;
    view_label: "UDM"
  }  # join events__target__asset__attribute__permissions

  join: events__target__asset__attribute__roles {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.asset.attribute.roles) as events__target__asset__attribute__roles ;;
    view_label: "UDM"
  }  # join events__target__asset__attribute__roles

  join: events__target__asset__hardware {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.asset.hardware) as events__target__asset__hardware ;;
    view_label: "UDM"
  }  # join events__target__asset__hardware

  join: events__target__asset__ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.asset.ip) as events__target__asset__ip ;;
    view_label: "UDM"
  }  # join events__target__asset__ip

  join: events__target__asset__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.asset.labels) as events__target__asset__labels ;;
    view_label: "UDM"
  }  # join events__target__asset__labels

  join: events__target__asset__mac {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.asset.mac) as events__target__asset__mac ;;
    view_label: "UDM"
  }  # join events__target__asset__mac

  join: events__target__asset__nat_ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.asset.nat_ip) as events__target__asset__nat_ip ;;
    view_label: "UDM"
  }  # join events__target__asset__nat_ip
  ...
  join: events__target__asset__vulnerabilities {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.asset.vulnerabilities) as events__target__asset__vulnerabilities ;;
    view_label: "UDM"
  }  # join events__target__asset__vulnerabilities
  ...
  join: events__target__domain__name_server {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.domain.name_server) as events__target__domain__name_server ;;
    view_label: "UDM"
  }  # join events__target__domain__name_server

  join: events__target__file__capabilities_tags {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.file.capabilities_tags) as events__target__file__capabilities_tags ;;
    view_label: "UDM"
  }  # join events__target__file__capabilities_tags

  join: events__target__file__embedded_domains {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.file.embedded_domains) as events__target__file__embedded_domains ;;
    view_label: "UDM"
  }  # join events__target__file__embedded_domains

  join: events__target__file__embedded_ips {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.file.embedded_ips) as events__target__file__embedded_ips ;;
    view_label: "UDM"
  }  # join events__target__file__embedded_ips

  join: events__target__file__embedded_urls {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.file.embedded_urls) as events__target__file__embedded_urls ;;
    view_label: "UDM"
  }  # join events__target__file__embedded_urls

  join: events__target__file__names {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.file.names) as events__target__file__names ;;
    view_label: "UDM"
  }  # join events__target__file__names

  join: events__target__file__pe_file__imports {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.file.pe_file.imports) as events__target__file__pe_file__imports ;;
    view_label: "UDM"
  }  # join events__target__file__pe_file__imports
  ...
  join: events__target__file__pe_file__resource {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.file.pe_file.resource) as events__target__file__pe_file__resource ;;
    view_label: "UDM"
  }  # join events__target__file__pe_file__resource

  join: events__target__file__pe_file__resources_language_count_str {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.file.pe_file.resources_language_count_str) as events__target__file__pe_file__resources_language_count_str ;;
    view_label: "UDM"
  }  # join events__target__file__pe_file__resources_language_count_str
  ...
  join: events__target__file__pe_file__section {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.file.pe_file.section) as events__target__file__pe_file__section ;;
    view_label: "UDM"
  }  # join events__target__file__pe_file__section

  join: events__target__file__signature_info__sigcheck__signers {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.file.signature_info.sigcheck.signers) as events__target__file__signature_info__sigcheck__signers ;;
    view_label: "UDM"
  }  # join events__target__file__signature_info__sigcheck__signers

  join: events__target__file__signature_info__sigcheck__x509 {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.file.signature_info.sigcheck.x509) as events__target__file__signature_info__sigcheck__x509 ;;
    view_label: "UDM"
  }  # join events__target__file__signature_info__sigcheck__x509

  join: events__target__file__tags {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.file.tags) as events__target__file__tags ;;
    view_label: "UDM"
  }  # join events__target__file__tags

  join: events__target__group__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.group.attribute.labels) as events__target__group__attribute__labels ;;
    view_label: "UDM"
  }  # join events__target__group__attribute__labels
  ...
  join: events__target__group__email_addresses {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.group.email_addresses) as events__target__group__email_addresses ;;
    view_label: "UDM"
  }  # join events__target__group__email_addresses

  join: events__target__investigation__comments {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.investigation.comments) as events__target__investigation__comments ;;
    view_label: "UDM"
  }  # join events__target__investigation__comments

  join: events__target__ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.ip) as events__target__ip ;;
    view_label: "UDM"
  }  # join events__target__ip

  join: events__target__ip_geo_artifact {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.ip_geo_artifact) as events__target__ip_geo_artifact ;;
    view_label: "UDM"
  }  # join events__target__ip_geo_artifact
  ...
  join: events__target__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.labels) as events__target__labels ;;
    view_label: "UDM"
  }  # join events__target__labels

  join: events__target__mac {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.mac) as events__target__mac ;;
    view_label: "UDM"
  }  # join events__target__mac

  join: events__target__nat_ip {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.nat_ip) as events__target__nat_ip ;;
    view_label: "UDM"
  }  # join events__target__nat_ip

  join: events__target__process__command_line_history {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.process.command_line_history) as events__target__process__command_line_history ;;
    view_label: "UDM"
  }  # join events__target__process__command_line_history

  join: events__target__process__file__capabilities_tags {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.process.file.capabilities_tags) as events__target__process__file__capabilities_tags ;;
    view_label: "UDM"
  }  # join events__target__process__file__capabilities_tags

  join: events__target__process__file__names {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.process.file.names) as events__target__process__file__names ;;
    view_label: "UDM"
  }  # join events__target__process__file__names

  join: events__target__process__file__pe_file__signature_info__signer {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.process.file.pe_file.signature_info.signer) as events__target__process__file__pe_file__signature_info__signer ;;
    view_label: "UDM"
  }  # join events__target__process__file__pe_file__signature_info__signer

  join: events__target__process__parent_process__file__capabilities_tags {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.process.parent_process.file.capabilities_tags) as events__target__process__parent_process__file__capabilities_tags ;;
    view_label: "UDM"
  }  # join events__target__process__parent_process__file__capabilities_tags

  join: events__target__process__parent_process__file__names {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.process.parent_process.file.names) as events__target__process__parent_process__file__names ;;
    view_label: "UDM"
  }  # join events__target__process__parent_process__file__names

  join: events__target__process_ancestors {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.process_ancestors) as events__target__process_ancestors ;;
    view_label: "UDM"
  }  # join events__target__process_ancestors

  join: events__target__resource__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.resource.attribute.labels) as events__target__resource__attribute__labels ;;
    view_label: "UDM"
  }  # join events__target__resource__attribute__labels

  join: events__target__resource__attribute__permissions {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.resource.attribute.permissions) as events__target__resource__attribute__permissions ;;
    view_label: "UDM"
  }  # join events__target__resource__attribute__permissions
  ...
  join: events__target__resource_ancestors {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.resource_ancestors) as events__target__resource_ancestors ;;
    view_label: "UDM"
  }  # join events__target__resource_ancestors

  join: events__target__resource_ancestors__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__target__resource_ancestors.attribute}.labels) as events__target__resource_ancestors__attribute__labels ;;
    view_label: "UDM"
  }  # join events__target__resource_ancestors__attribute__labels

  join: events__target__resource_ancestors__attribute__permissions {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__target__resource_ancestors.attribute}.permissions) as events__target__resource_ancestors__attribute__permissions ;;
    view_label: "UDM"
  }  # join events__target__resource_ancestors__attribute__permissions

  join: events__target__user__attribute__labels {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.user.attribute.labels) as events__target__user__attribute__labels ;;
    view_label: "UDM"
  }  # join events__target__user__attribute__labels
  ...
  join: events__target__user__attribute__roles {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.user.attribute.roles) as events__target__user__attribute__roles ;;
    view_label: "UDM"
  }  # join events__target__user__attribute__roles

  join: events__target__user__department {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.user.department) as events__target__user__department ;;
    view_label: "UDM"
  }  # join events__target__user__department

  join: events__target__user__email_addresses {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.user.email_addresses) as events__target__user__email_addresses ;;
    view_label: "UDM"
  }  # join events__target__user__email_addresses

  join: events__target__user__group_identifiers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.user.group_identifiers) as events__target__user__group_identifiers ;;
    view_label: "UDM"
  }  # join events__target__user__group_identifiers

  join: events__target__user__managers {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events.target}.user.managers) as events__target__user__managers ;;
    view_label: "UDM"
  }  # join events__target__user__managers

  join: events__target__user__managers__attribute__labels {
    relationship: one_to_many
  ...
  join: events__target__user__managers__attribute__roles {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${events__target__user__managers.attribute}.roles) as events__target__user__managers__attribute__roles ;;
    view_label: "UDM"
  }  # join events__target__user__managers__attribute__roles

  join: events__target__user__managers__department {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__target__user__managers.department}) as events__target__user__managers__department ;;
    view_label: "UDM"
  }  # join events__target__user__managers__department

  join: events__target__user__managers__email_addresses {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__target__user__managers.email_addresses}) as events__target__user__managers__email_addresses ;;
    view_label: "UDM"
  }  # join events__target__user__managers__email_addresses

  join: events__target__user__managers__group_identifiers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__target__user__managers.group_identifiers}) as events__target__user__managers__group_identifiers ;;
    view_label: "UDM"
  }  # join events__target__user__managers__group_identifiers

  join: events__target__user__managers__phone_numbers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events__target__user__managers.phone_numbers}) as events__target__user__managers__phone_numbers ;;
    view_label: "UDM"
  }  # join events__target__user__managers__phone_numbers

  join: events__target__user__phone_numbers {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${events.target}.user.phone_numbers) as events__target__user__phone_numbers ;;
    view_label: "UDM"
  }  # join events__target__user__phone_numbers

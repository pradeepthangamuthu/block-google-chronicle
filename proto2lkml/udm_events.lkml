...
{%condition%}${udm_events.src__artifact__ip} {%endcondition%} or 
...
{%condition%}${udm_events.target__asset__network_domain} {%endcondition%}
;;
  } # domain
...
;;
  ...
  filter: file_path_grouped_field_filter {
    ...
    sql:  {%condition%} ${udm_events.principal__file__full_path} {%endcondition%} or 
{%condition%}${udm_events.target__file__full_path} {%endcondition%} or 
...
view: udm_events__about__ip_location {
...
view: udm_events__principal__artifact__network__dns__answers {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "principal"
...
view: udm_events__principal__file__names {
  dimension: udm_events__principal__file__names {
    type: string
    sql: ${TABLE} ;;
    group_label: "principal"
...
view: udm_events__src__artifact__network__dns__questions {
  dimension: name {
    type: string
    sql: ${TABLE}.name ;;
    group_label: "src"
...
view: udm_events__target__artifact__network__email__subject {
  dimension: udm_events__target__artifact__network__email__subject {
    type: string
    sql: ${TABLE} ;;
    group_label: "target"
...
explore: udm_events {
  ...
  join: udm_events__observer__asset__vulnerabilities {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${udm_events.observer}.asset.vulnerabilities) as udm_events__observer__asset__vulnerabilities ;;
    view_label: "UDM"
  }  # join udm_events__observer__asset__vulnerabilities
  ...
  join: udm_events__principal__artifact__network__dns__answers {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${udm_events.principal}.artifact.network.dns.answers) as udm_events__principal__artifact__network__dns__answers ;;
    view_label: "UDM"
  }  # join udm_events__principal__artifact__network__dns__answers
  ...
  join: udm_events__principal__file__names {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${udm_events.principal}.file.names) as udm_events__principal__file__names ;;
    view_label: "UDM"
  }  # join udm_events__principal__file__names
  ...
  join: udm_events__src__artifact__network__dns__questions {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${udm_events.src}.artifact.network.dns.questions) as udm_events__src__artifact__network__dns__questions ;;
    view_label: "UDM"
  }  # join udm_events__src__artifact__network__dns__questions
  ...
  join: udm_events__src__process_ancestors {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${udm_events.src}.process_ancestors) as udm_events__src__process_ancestors ;;
    view_label: "UDM"
  }  # join udm_events__src__process_ancestors
  ...
  join: udm_events__target__artifact__network__email__subject {
    relationship: one_to_one
    sql: LEFT JOIN UNNEST(${udm_events.target}.artifact.network.email.subject) as udm_events__target__artifact__network__email__subject ;;
    view_label: "UDM"
  }  # join udm_events__target__artifact__network__email__subject
  ...
  join: udm_events__target__user_management_chain {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${udm_events.target}.user_management_chain) as udm_events__target__user_management_chain ;;
    view_label: "UDM"
  }  # join udm_events__target__user_management_chain
